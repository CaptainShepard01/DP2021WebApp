package com.company.logic.models;
    ...
    public void showEmployees() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                System.out.println(new Employee(id, name, isDepartmentHead, lengthOfEmployment, unitId));
            }
            resultSet.close();
        } catch (SQLException e) {
            System.out.println(" >>     " + e.getMessage());
    ...
    public List<Employee> getEmployees() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                result.add(new Employee(id, name, isDepartmentHead, lengthOfEmployment, unitId));
            }
            resultSet.close();
            return result;
        } catch (SQLException e) {
